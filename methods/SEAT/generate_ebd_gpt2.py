""" Generate GPT2 embeddings, execute SEAT method, and save results """
import pickle
import datetime
import time
import math
...
# excluded 'dis_term', 'dism_term', 'occ_name', 'occ_term', 'ibd_name', 'ibd_term', 'eibd_name', 'eibd_term'
...
results_path = time.strftime("%Y%m%d-%H%M%S") + '_SEAT_gpt2_reddit.csv'
