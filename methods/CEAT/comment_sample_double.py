""" sample comments for double word dataset from data_files"""
import pickle
import random
random.seed(1111)
...
dataset = pickle.load(open('data_files/sent_dict_double_1.pickle','rb'))
for i in range(2,13):
    dataset_to_merge_name = 'data_files/sent_dict_double_' + str(i) + '.pickle'
...
pickle.dump(dataset, open('data_files/sent_dict_double.pickle', 'wb'))
